...
@ApiModel(description = "產品大分類 MainClass table 資料")
@Data
@Entity
...
public class MainClass implements Serializable {
    ...
    // 單向一對多, MainClass 可找到 這 ProductClass,  ProductClass 找不到 MainClass
    @OneToMany(fetch=FetchType.LAZY)
    @JoinColumn(name="mainClassId")
    @OrderBy("createDate DESC")
    @Where(clause = "is_active=1")
    @JsonIgnore
    protected Set<ProductClass> productClasses = new HashSet<>();
    ...
    @ApiModelProperty(required = true, value = "產品大分類名称")
